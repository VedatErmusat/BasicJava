...
public class MyMath {
    public static void main(String[] args) {
        ...
        while(true) {
            System.out.println("----------------------");
            System.out.println("Hypotenuse: 1, Multiples: 2, Is Even: 3, Square of Asteriks: 4, Square of Any Character: 5, Circle Area: 6, Create a random number: 7, Heads Or Tails: 8 ,TheMathGame: 9 ,Close: 0");
